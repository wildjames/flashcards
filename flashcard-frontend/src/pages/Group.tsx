...
import { CardData, GroupData, UserData } from "@common/types";

export default function GroupPage() {
    // Refactor to use react router stuff
    ...
    useEffect(() => {
        ...
        if (!groupId) {
            setGroupError("Group ID not found");
            setLoadingGroup(false);
            return;
        }

        // TODO: Refactor to use the axiosInstance
